...
export default function Edit({ feedback }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        nama_depan: feedback.nama_depan ?? "",
        nama_belakang: feedback.nama_belakang ?? "",
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route("admin.feedbacks.update", feedback.id_feedback));
    };
        ...
        <AuthenticatedLayout
            ...
            header={
                <div>
                    ...
                    <p className="text-md">
                        Ubah data Feedback ke dalam sistem
                    </p>
                </div>
            }
        >
            <Head title="Edit Data Feedback" />
